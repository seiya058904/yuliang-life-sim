...
export const officialServices = [
  ...
  { id: 'service.fitness-assessment', contentStatus: 'official', name: '基础体能评估', description: '用一次简短评估重新认识自己的体能状态，给接下来的生活安排一个更实际的起点。', tags: ['life'], price: 240, financialCategory: 'service', effects: [{ type: 'attribute', attribute: 'fitness', amount: 1 }] },
