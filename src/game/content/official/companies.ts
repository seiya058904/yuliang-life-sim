...
export const officialCompanies: readonly CompanyDefinition[] = [
  ...
  { id: 'company.qiming', contentStatus: 'official', name: '启明服务', description: '为本地客户提供运营与客户服务。', tags: ['work', 'career'], industry: '服务', locationId: 'location.industrial', jobIds: ['job.seed-shop-clerk', 'job.cafe-assistant', 'job.delivery-shift'] },
];
