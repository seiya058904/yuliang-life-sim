...
describe('seed content registry', () => {
  ...
  it('populates bounded company histories for every official company', () => {
    const companies = contentRegistry.companies?.filter((company) => company.contentStatus === 'official') ?? [];
